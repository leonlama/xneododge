...
class SkipTicket(BaseShopItem):
    def __init__(self):
        super().__init__("Skip Ticket", "Skip the next wave and earn bonus score", 35)
...
class Smokescreen(BaseShopItem):
    def __init__(self):
        super().__init__("Smokescreen", "-25% enemies for next 5 waves", 40)
...
class ChaserRepellent(BaseShopItem):
    def __init__(self):
        super().__init__("Chaser Repellent", "No Chasers for next 5 waves", 35)
...
class EMPPulse(BaseShopItem):
    def __init__(self):
        super().__init__("EMP Pulse", "No Shooters for next 5 waves", 35)
...
class BombDefuser(BaseShopItem):
    def __init__(self):
        super().__init__("Bomb Defuser", "No Bombers for next 5 waves", 35)
...
class MazeJammer(BaseShopItem):
    def __init__(self):
        super().__init__("Maze Jammer", "No Wanderers for next 5 waves", 35)
