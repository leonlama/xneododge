...
class CDRCore(BaseShopItem):
    def __init__(self):
        super().__init__("CDR Core", "-10% Artifact Cooldown permanently", 60, "uncommon")
...
class MMSChip(BaseShopItem):
    def __init__(self):
        super().__init__("MMS Chip", "+15% Movement Speed permanently", 60, "uncommon")
...
class SpawnBooster(BaseShopItem):
    def __init__(self):
        super().__init__("Spawn Booster", "+10% orb spawn chance", 50, "uncommon")
...
class GoldTooth(BaseShopItem):
    def __init__(self):
        super().__init__("Gold Tooth", "+10% coin drop chance", 50, "uncommon")
...
class AbsorptionModule(BaseShopItem):
    def __init__(self):
        super().__init__("Absorption Module", "10% chance to ignore damage", 70, "uncommon")
