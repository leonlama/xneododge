...
class OverclockFlask(BaseShopItem):
    def __init__(self):
        super().__init__("Overclock Flask", "-30% Artifact Cooldowns (3 waves)", 45)
...
class EnergySurge(BaseShopItem):
    def __init__(self):
        super().__init__("Energy Surge", "+25% Movement Speed (3 waves)", 45)
...
class PointMagnet(BaseShopItem):
    def __init__(self):
        super().__init__("Point Magnet", "1.5x Score Multiplier (3 waves)", 50)
...
class ShieldProtocol(BaseShopItem):
    def __init__(self):
        super().__init__("Shield Protocol", "Gain shield that blocks 1 hit", 40)
